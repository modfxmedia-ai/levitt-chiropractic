...
export const metadata: Metadata = generateMeta({
  ...
  description:
    "Everything new patients need to prepare for their first visit at Levitt Chiropractic Center in Saint Louis Park, MN — online forms, what to expect, and a quick checklist.",
